...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_competitor_activities_visit_id", "competitor_activities", ["visit_id"], unique=False
    )


def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index("ix_competitor_activities_visit_id", table_name="competitor_activities")
