...
SEARCHABLE_FIELDS: Sequence[InstrumentedAttribute[Any]] = (Position.name, Position.code)
...
class PositionRepository(BaseRepository[Position]):
    """Data access layer for `Position`. Never commits or rolls back."""
    ...
    async def paginate(
        ...
        *,
        ...
        Filterable by `organization_id` and `department_id`.
        """
