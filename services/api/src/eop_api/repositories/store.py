...
SEARCHABLE_FIELDS: Sequence[InstrumentedAttribute[Any]] = (Store.code, Store.name)
...
class StoreRepository(BaseRepository[Store]):
    """Data access layer for `Store`. Never commits or rolls back."""
    ...
    async def paginate(
        ...
        *,
        ...
        Filterable by `organization_id`/`store_type_id`.
        """
