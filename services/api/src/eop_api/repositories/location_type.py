...
SEARCHABLE_FIELDS: Sequence[InstrumentedAttribute[Any]] = (LocationType.name,)


class LocationTypeRepository(BaseRepository[LocationType]):
    """Data access layer for `LocationType`. Never commits or rolls back."""

    def __init__(self, session: AsyncSession) -> None:
        super().__init__(session, LocationType)
